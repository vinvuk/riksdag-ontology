...
""")
    ...
    # Sub-diagrams — embed Mermaid HTML snippets
    _title_map = {
    ...
    if diagram_files:
        ...
        parts.append('<p class="meta">Solid arrows = subclass (rdfs:subClassOf). '
                     'Dashed arrows = object properties. '
...
<script>mermaid.initialize({startOnLoad:true, theme:'neutral', flowchart:{curve:'basis', padding:20}});</script>
</body>
</html>""")
